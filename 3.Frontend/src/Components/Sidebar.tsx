      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-700 group cursor-pointer">
                <svg
                ...
                <span className="ml-3">
                  <Link to="/empleados" className="text-white">
                    Employess
                  </Link>
                </span>
              </a>
